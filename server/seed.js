...
const events = [
...

    {
        ...
        location:
            "Sports Ground, Sobhasaria Group of Institutions, Sikar",
        category: "sports",
        totalSeats: 600,
        ticketPrice: 50,
        imageUrl:
...

    {
        ...
        location:
            "College Football Ground, Sobhasaria, Sikar",
        category: "sports",
        totalSeats: 400,
        ticketPrice: 50,
        imageUrl:
...

    {
        ...
        location:
            "Indoor Sports Complex, Sobhasaria, Sikar",
        category: "sports",
        totalSeats: 250,
        ticketPrice: 30,
        imageUrl:
...

    {
        ...
        location:
            "Main Sports Ground, Sobhasaria, Sikar",
        category: "sports",
        totalSeats: 350,
        ticketPrice: 30,
        imageUrl:
...

    {
        ...
        location:
            "Computer Science Department, Sobhasaria, Sikar",
        category: "technology",
        totalSeats: 300,
        ticketPrice: 200,
        imageUrl:
...

    {
        ...
        location:
            "Innovation Lab, Sobhasaria Group of Institutions, Sikar",
        category: "technology",
        totalSeats: 250,
        ticketPrice: 100,
        imageUrl:
...

    {
        ...
        location:
            "Conference Hall, Sobhasaria Group of Institutions, Sikar",
        category: "technology",
        totalSeats: 300,
        ticketPrice: 100,
        imageUrl:
...

    {
        ...
        location:
            "Innovation Lab, Sobhasaria, Sikar",
        category: "technology",
        totalSeats: 250,
        ticketPrice: 150,
        imageUrl:
...

    {
        ...
        location:
            "College Auditorium, Sobhasaria, Sikar",
        category: "cultural",
        totalSeats: 600,
        ticketPrice: 100,
        imageUrl:
...

    {
        ...
        location:
            "Seminar Hall, Sobhasaria Group of Institutions, Sikar",
        category: "career",
        totalSeats: 400,
        ticketPrice: 0,
        imageUrl:
...

    {
        ...
        location:
            "Innovation Hall, Sobhasaria, Sikar",
        category: "business",
        totalSeats: 250,
        ticketPrice: 100,
        imageUrl:
...

    {
        ...
        location:
            "Conference Hall, Sobhasaria, Sikar",
        category: "business",
        totalSeats: 300,
        ticketPrice: 50,
        imageUrl:
...

    {
        ...
        location:
            "College Open Ground, Sobhasaria, Sikar",
        category: "entertainment",
        totalSeats: 1000,
        ticketPrice: 300,
        imageUrl:
...
const seedDatabase = async () => {
    try {
        ...
        const sportsCount = events.filter(
            (event) => event.category === "sports"
        ).length;

        const technologyCount = events.filter(
            (event) => event.category === "technology"
        ).length;

        const culturalCount = events.filter(
            (event) => event.category === "cultural"
        ).length;

        const careerCount = events.filter(
            (event) =>
                event.category === "career" ||
                event.category === "business"
        ).length;

        const entertainmentCount = events.filter(
            (event) => event.category === "entertainment"
        ).length;
