...
<div className="flex items-center gap-4 text-gray-600">
    ...
    <div>
        ...
        <div className="font-bold text-gray-800 space-y-1">
            <p>Total Seats: {event.totalSeats}</p>

            <p>
                Booked Seats: {event.totalSeats - event.availableSeats}
            </p>
            ...
            >
                Remaining Seats: {event.availableSeats}
                            ...
                            {showOTP && (
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-gray-700 text-center font-bold tracking-widest"
                                        value={otp}
                            ...
                            {/* Messages */}
                            {error && (
                                <p className="text-red-500 mt-4 text-center bg-red-50 p-2 rounded">
                                    {error}
                                </p>
                            )}

                            {successMsg && (
                                <p className="text-green-600 mt-4 text-center bg-green-50 p-2 rounded">
                                    {successMsg}
                                </p>
                            )}
                        </div>
